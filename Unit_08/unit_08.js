...
for (let num = 1; num <= 50; num++) {
    document.querySelector('.out-1').innerHTML += num + '_'
}
}
...
while (k <= 46) {
    k = k + 2;
document.querySelector('.out-2').innerHTML += k + '_'
}
}
...
while (k > 7) {
    k--
    document.querySelector('.out-3').innerHTML += k + '_'
}
...
while (k > 35) {
    k = k - 3
    document.querySelector('.out-4').innerHTML += k + '_' 
}
}
...
while (k < 17) {
    k++
    if (k % 2 == 0) {
        document.querySelector('.out-5').innerHTML += k + '_**'
    }
    else {
        document.querySelector('.out-5').innerHTML += k + '_*'
    }
...
while (num >= 0 ) {
    document.querySelector('.out-7').innerHTML += num + '_'
    num--;
}
}
...
while (num1 <= num2) {
    i++;
    document.querySelector('.out-8').innerHTML += num1 + '_';
}
}
...
function t9() {
let n1 = +document.querySelector('.i-91').value;
let n2 = +document.querySelector('.i-92').value;
let min = n1 < n2 ? n1 : n2;
let max = n1 > n2 ? n1 : n2;

while (min <= max) {
    document.querySelector('.out-9').innerHTML += min + '_';
    min++;
}
}
...
while (k < 1966) {
    k = k + 2;
    document.querySelector('.out-10').innerHTML += k + '_'
}
}
...
while (i < divs.length) {
    document.querySelector('.out-11').innerHTML += divs[i].innerHTML + '_' 
    i++
}
}
...
while (i < elem.length) {
    if (elem[i].checked ) {
        document.querySelector('.out-14').innerHTML += elem[i].value + '_';
    }
    i++
}
}
...
while (k < 3) {
    document.querySelector('.out-15').innerHTML += '77_88_99_'
    k++
}
